...
export default function Home() {
  ...
  return (
    <>
<Head>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"FAQPage\", \"mainEntity\": [{\"@type\": \"Question\", \"name\": \"What is NeighborhoodGuide?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"NeighborhoodGuide is a tool that writes a lifestyle-focused neighborhood description from a neighborhood and the buyer profile.\"}}, {\"@type\": \"Question\", \"name\": \"What does it include?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Lifestyle framing, buyer-matched highlights, nearby highlights, and relocation-ready copy.\"}}, {\"@type\": \"Question\", \"name\": \"Is it tailored to the buyer?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Yes. It matches the blurb to who is moving there.\"}}, {\"@type\": \"Question\", \"name\": \"Where can I use the copy?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Listings, relocation packets, or your own site.\"}}, {\"@type\": \"Question\", \"name\": \"Who should use it?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"Agents and relocation teams who want location copy that sells lifestyle.\"}}, {\"@type\": \"Question\", \"name\": \"Does it highlight nearby spots?\", \"acceptedAnswer\": {\"@type\": \"Answer\", \"text\": \"It includes nearby highlights relevant to the buyer profile.\"}}]}" }} />

        <title>{`${PRODUCT.name} — ${PRODUCT.tagline}`}</title>
        <meta name="description" content={PRODUCT.description} />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="canonical" href="https://neighborhoodguide.lxsaihub.com/" />
      </Head>
