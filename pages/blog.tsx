...
const howToSteps = [
  { name: 'Open NeighborhoodGuide', text: 'Go to the workspace and enter the inputs NeighborhoodGuide asks for.' },
  { name: 'Generate the draft', text: 'Run NeighborhoodGuide to get a structured plain-English result.' },
...
export default function Page() {
  ...
  const SHORT = "NeighborhoodGuide writes a lifestyle-focused neighborhood description from a neighborhood and who is moving there."
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">NeighborhoodGuide writes a lifestyle-focused neighborhood description from a neighborhood and who is moving there.</p>
