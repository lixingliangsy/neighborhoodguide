 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="neighborhoodguide" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "neighborhoodguide";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "neighborhoodguide") + "_chat_session";
