...
export const PIPELINE_ID = 'neighborhoodguide-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Neighborhood & buyer profile",
  process: "Step 2/3 · Lifestyle framing + nearby highlights",
  output: "Step 3/3 · Relocation-ready blurb",
}
